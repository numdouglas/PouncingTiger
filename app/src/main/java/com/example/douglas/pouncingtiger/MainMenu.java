...
public class MainMenu extends GLScreen {
    ...
    public MainMenu(Game game) {
        ...
        unlockBounds=new Rectangle(256,0,320,64);
        ...
        for(int i = 0; i < len; i++) {
            ...
            if(event.type == TouchEvent.TOUCH_UP) {
               ...
               /* if(OverlapTester.pointInRectangle(helpBounds, touchPoint)) {
                ...
                if(OverlapTester.pointInRectangle(unlockBounds,touchPoint)){
                    Assets.playSound(Assets.clickSound);
                    game.setScreen(new SelectaPlayerScreen(game));
                    return;
                }
    ...
    public void present(float deltaTime) {
        ...
        batcher.drawSprite(288,32,64,64,Assets.basket);
        batcher.endBatch();
