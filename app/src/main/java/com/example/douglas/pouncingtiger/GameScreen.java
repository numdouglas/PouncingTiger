...
import com.example.douglas.pouncingtiger.World.WorldListener;
...
public class GameScreen extends GLScreen {
    ...
    public GameScreen(Game game) {
        ...
        worldListener = new WorldListener() {
            ...
            public void crack(){Assets.playSound(Assets.crackSound);}
        };
    ...
    private void presentRunning() {
        ...
        Assets.font.drawText(batcher, scoreString, 16, 480-20);//present graphics for transtion if game is running
    }
    ...
    private void presentLevelEnd() {
        String topText = "tiger brother is ...";
